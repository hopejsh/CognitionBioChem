<!-- RELEASE-NOTE-FROZEN: this is the body of the published v1.1.0 GitHub release and the
     description behind version DOI 10.5281/zenodo.22070599. It was generated by
     platform/build_release_notes.py from data/, prespec/ and verify_all.SUITES, and matched
     that rebuild byte-for-byte at the moment v1.1.0 was tagged on 2026-08-23; freezing it
     here is what stops a later rebuild from rewriting the record of a published release.
     platform/check_version_stamps.py reads this marker as the fact that v1.1.0 is published. -->
